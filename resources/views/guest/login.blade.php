                ...
                <form method="POST" action="{{ route('login') }}?lang={{ app()->getLocale() }}"
                    ...
                    <div class="pt-6 relative">
                        ...
                        <input required type="text" name="login" id="login" minlength="3"
                            ...
                            class="focus:shadow-focus-box focus:border focus:outline-none focus:border-blue-750       mt-2 border {{ $errors->any() ? 'border-error' : 'border-neutral-250' }} rounded-lg py-[18px] px-6 xs:w-[392px] w-[343px] placeholder-zinc-550 placeholder:leading-8.5 placeholder:font-normal">
