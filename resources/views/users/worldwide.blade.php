        ...
        <div class="pl-4 pt-6 md:px-[108px] xs:pt-10">
            ...
            <div class="grid grid-cols-6 gap-4 xs:gap-6 pt-10">
                <div
                    ...
                    <h1 class="font-black xs:text-[39px] xs:leading-[47px] text-2xl leading-[30px] text-blue-750">
                        {{ $confirms }}</h1>
                </div>
                <div
                    ...
                    <h1 class="font-black xs:text-[39px] xs:leading-[47px] text-2xl leading-[30px] text-green-550">
                        {{ $recovers }}
                    </h1>
                </div>
                <div
                    ...
                    <h1 class="font-black xs:text-[39px] xs:leading-[47px] text-2xl leading-[30px] text-yellow-450">
                        {{ $deaths }}
                    </h1>
                </div>
            </div>
